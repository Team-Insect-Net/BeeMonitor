...
class VideoAnalyzer:
    ...
    def processNestDetection(self, video_path, nest_detection):
        return nest_processor.processNestDetection(video_path, nest_detection, self.res_height, self.res_width)
